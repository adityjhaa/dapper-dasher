...
int main(){
    ...
    animdata nebdata{{0.0,0.0,nebula.width/8.0,nebula.height/8.0},{width,height/1.0-nebula.height/8},0,1.0/12.0,0.0};

    int nebulavel{-500};

    Texture2D scarfy = LoadTexture("textures/scarfy.png");
    animdata scarfydata{{0.0,0.0,scarfy.width/6.0,scarfy.height/1.0},{width/5,height/1.0-scarfy.height},0,1.0/12.0,0.0};
